...
jobs = [
    ...
    f" python main.py {common_opts} Trainer.name=meanteacher Trainer.save_dir={save_dir}/mt/0.01 "
    f" MeanTeacherParameters.weight=0.01 ",

    f" python main.py {common_opts} Trainer.name=meanteacher Trainer.save_dir={save_dir}/mt/0.1 "
    f" MeanTeacherParameters.weight=0.1 ",

    f" python main.py {common_opts} Trainer.name=meanteacher Trainer.save_dir={save_dir}/mt/0.5 "
    f" MeanTeacherParameters.weight=0.5 ",
    ...
    # uda
    f" python main.py {common_opts} Trainer.name=uda Trainer.save_dir={save_dir}/uda/mse/0.05 "
    f" UDARegCriterion.name=mse UDARegCriterion.weight=0.05  ",

    f" python main.py {common_opts} Trainer.name=uda Trainer.save_dir={save_dir}/uda/mse/0.1 "
    ...
    f" python main.py {common_opts} Trainer.name=iic Trainer.save_dir={save_dir}/iic/0.00001 "
    f" IICRegParameters.weight=0.00001 ",

    f" python main.py {common_opts} Trainer.name=iic Trainer.save_dir={save_dir}/iic/0.0001 "
    f" IICRegParameters.weight=0.0001 ",
