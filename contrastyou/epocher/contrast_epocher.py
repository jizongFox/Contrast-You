...
class PretrainEncoderEpoch(_Epocher):
    ...
    @staticmethod
    def _label_generation(partition_list: List[str], group_list: List[str]):
...
class PretrainDecoderEpoch(PretrainEncoderEpoch):
    ...
    @staticmethod
    def _label_generation(partition_list: List[str], group_list: List[str], folder_partition: List[str]):
