...
class tqdm(_tqdm):
    ...
    def __init__(self, iterable=None, desc=None, total=None, leave=False, file=None, ncols=1, mininterval=0.1,
    ...
    def print_result(self):
        if hasattr(self, "__cached__"):
            return self.desc + "    " + create_meter_display(self.__cached__)
        return ""
