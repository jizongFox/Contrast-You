...
from semi_seg.data.creator import get_data, get_eval_train_data
...
def worker(config, absolute_save_dir, seed):
    ...
    if save_test_data:
        labeled_loader, unlabeled_loader, val_loader, test_loader=get_eval_train_data(data_params=config["Data"], labeled_loader_params=config["LabeledLoader"],
        ...
        if is_pretrain:
            ...
            with model.switch_grad(False, start=until, include_start=False):
                ...
                if checkpoint:
                    ...
                    trainer._max_epoch=10000
                trainer.disable_affine_transformer()
